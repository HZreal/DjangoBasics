...
# print(__file__)
# print(Path(__file__))
# print(Path(__file__).resolve())                            # 这三个输出结果均是 F:\Django\DjangoBasics\DjangoBasics\settings.py
# print(Path(__file__).resolve().parent)                     # F:\Django\DjangoBasics\DjangoBasics
# print(BASE_DIR)                                            # F:\Django\DjangoBasics
# 早期版本如下
# BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
# 其中__file__表示本文件setting.py文件名
# abspath(__file__)获取本文件绝对路径 F:\Django\DjangoBasics\DjangoBasics\settings.py
# dirname获取本文件所在文件夹(目录)路径 F:\Django\DjangoBasics\DjangoBasics 即获取父级目录
# 外层dirname再取上上级文件夹路径 F:\Django\DjangoBasics 即是BASE_DIR
